...
const ROWS: AuditRow[] = [
  { time: '2026-08-08 09:41:12', user: 'a.karimov',    role: 'Administrator',  action: 'Kirish',             object: 'Tizim',                ok: true  },
  { time: '2026-08-08 09:41:38', user: 'a.karimov',    role: 'Administrator',  action: "Sozlama o'zgarishi", object: 'Indeks parametrlari',   ok: true  },
  { time: '2026-08-08 09:43:05', user: 'n.yusupova',   role: 'Rahbar',         action: 'Kirish',             object: 'Tizim',                ok: true  },
  { time: '2026-08-08 09:44:17', user: 'n.yusupova',   role: 'Rahbar',         action: 'Qidiruv',            object: "ko'chat ekish topshiriqlari", ok: true },
  { time: '2026-08-08 09:46:02', user: 'n.yusupova',   role: 'Rahbar',         action: "Hujjat ko'rish",     object: '112-F Farmoyish',       ok: true  },
  { time: '2026-08-08 09:48:30', user: 'b.toshmatov',  role: 'Ijrochi',        action: 'Kirish',             object: 'Tizim',                ok: true  },
  { time: '2026-08-08 09:49:11', user: 'b.toshmatov',  role: 'Ijrochi',        action: "Hujjat ko'rish",     object: '31-M Maxfiy qaror',     ok: false, reason: 'Maxfiylik darajasi yetarli emas' },
  { time: '2026-08-08 09:49:44', user: 'b.toshmatov',  role: 'Ijrochi',        action: 'Qidiruv',            object: 'byudjet taqsimoti',     ok: true  },
  { time: '2026-08-08 09:52:18', user: 'm.ergasheva',  role: 'Kotibiyat',      action: 'Yuklash',            object: 'hisobot_2024.pdf',      ok: true  },
  { time: '2026-08-08 09:54:03', user: 'm.ergasheva',  role: 'Kotibiyat',      action: 'Tasdiqlash',         object: '78-R Tasniflash',       ok: true  },
  { time: '2026-08-08 09:57:29', user: 's.nazarov',    role: 'Ijrochi',        action: "Sozlama o'zgarishi", object: 'Foydalanuvchi profili', ok: false, reason: "Administrator huquqi talab etiladi" },
  { time: '2026-08-08 10:02:44', user: 'a.karimov',    role: 'Administrator',  action: 'Chiqish',            object: 'Tizim',                ok: true  },
]
    ...
    <div style={{
          ...
          <tbody>
            {ROWS.map((row, i) => (
              ...
              >
                ...
                <td style={{ padding: '0 14px', height: 40 }}>
                  <Mono size={11} color="var(--ink-3)">{IP_MAP[row.user]}</Mono>
                </td>
                <td style={{ padding: '0 14px', height: 40 }}>
      ...
      <div style={{
        ...
        <span style={{ fontFamily: 'var(--sans)', fontSize: 11, color: 'var(--ink-3)' }}>
          Jami <Mono size={11} color="var(--ink)">12</Mono> ta yozuv ko'rsatilmoqda
        </span>
        <span style={{ flex: 1 }} />
        <span style={{ fontFamily: 'var(--sans)', fontSize: 11, color: 'var(--danger)' }}>
          <Mono size={11} color="var(--danger)">2</Mono> ta rad etilgan harakat
        </span>
      </div>
    </div>
  )
