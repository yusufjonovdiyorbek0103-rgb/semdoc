...
function UploadZone() {
  ...
  return (
    ...
    >
      <input ref={inputRef} type="file" multiple accept=".pdf,.docx,.doc,.jpg,.png" style={{ display: 'none' }} />
      ...
      <p style={{ fontFamily: 'var(--sans)', fontSize: 12, color: 'var(--ink-3)', margin: 0 }}>
        PDF, DOCX, DOC, JPG, PNG · maksimal 50 MB
      </p>
      <button
        ...
        <div style={{ padding: '28px 32px 48px' }}>
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 14, color: 'var(--ink-2)', margin: 0, lineHeight: 1.6 }}>
              PDF, DOCX va skaner qilingan fayllarni yuklang. Tizim matnni ajratadi, normalizatsiya qiladi va indekslaydi.
            </p>
          </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <span style={{ fontSize: 11, color: 'var(--rel-50)', fontWeight: 500 }}>
                      1 jarayonda
                    </span>
